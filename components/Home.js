...
const image = { uri: "https://s2.best-wallpaper.net/wallpaper/iphone/1808/Bitcoin-money-PCB-creative-design_iphone_750x1334.jpg" };
      ...
      <ImageBackground source={image} style={styles.image}>
        <SafeAreaView style={styles.container2}>
          ...
          <View style={styles.contents2}>
              <Text style={{color: '#FFFFFF', fontSize: 50, fontWeight: 'bold'}}>FROM</Text>
              <Picker
              ...
              <Text style={{color: '#FFFFFF', fontSize: 50, fontWeight: 'bold'}}>TO</Text>
              <Picker
              ...
              <Text style={{color: '#FFFFFF', fontSize: 50, fontWeight: 'bold'}}>AMOUNT</Text>
              ...
              {selectedToValue == "CAD" && (
                  <Text style={{color: '#FFFFFF'}}>CAD: {selectedCurrency.CAD * input}</Text>
              )}
              {selectedToValue == "AUD" && (
                  <Text style={{color: '#FFFFFF'}}>AUD: {selectedCurrency.AUD * input}</Text>
              )}
              {selectedToValue == "EUR" && (
                  <Text style={{color: '#FFFFFF'}}>EUR: {selectedCurrency.EUR * input}</Text>
              )}
              {selectedToValue == "MXN" && (
                  <Text style={{color: '#FFFFFF'}}>MXN: {selectedCurrency.MXN * input}</Text>
              )}
              {selectedToValue == "PLN" && (
                  <Text style={{color: '#FFFFFF'}}>PLN: {selectedCurrency.PLN * input}</Text>
              )}
